...
// Données bilingues du footer (FR / EN)
const footerData = {
  fr: {
    ...
    copyright: "© 2025 Safety Cards. Tous droits réservés.",
  ...
  en: {
    ...
    copyright: "© 2025 Safety Cards. All rights reserved.",
            ...
            <div>
              {cat.links.map((l, i) => (
                <React.Fragment key={l.path}>
                  <Link to={l.path}>{l.label}</Link>{i < cat.links.length - 1 && <br />}
                </React.Fragment>
              ))}
            </div>
          </div>
