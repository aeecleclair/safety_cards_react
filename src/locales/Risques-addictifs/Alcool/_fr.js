const fr = {
  pageTitle: "Consommation d'alcool",
  navLinks: [
  ...
  effetsTitle: "Quels sont les effets de l'alcool ?",
  effetsText: "On considère qu'une personne est sous l'effet de l'alcool si elle ressent <b>plusieurs de ces symptômes</b>, quasi systématiquement et <b>pendant plusieurs heures après consommation</b> :",
  effetsList: [
  ...
  possibleDrugged: "Tu ressens ces symptômes, alors que tu n'as (presque) pas bu ? Tu as peut-être été <b>drogué·e à ton insu</b>.",
  resources4: [
    { link: "/soumission", emoji: "💊", label: "Soumission chimique", description: "Comment réagir si je pense avoir été drogué·e à mon insu ?" }
  ],

  banalisationText: "A l'école, l'alcool n'est pas un sujet anodin et sa consommation y est bien souvent <b>banalisée</b>, comme le montrent les chiffres suivants :",
  data: [
  ...
  risquesTitle: "Quels sont les risques ?",
  risqueMoi: "Ce que je risque sur <b>moi</b> :",
  risqueMoiList: [
  ...
  quote1: "Bourré·e ou pas, c'était bien moi.",
  risqueAutres: "Ce que je risque sur <b>les autres</b> :",
  risqueAutresList: [
  ...
  consoIntroText: "Pour limiter les risques liés à la consommation d'alcool, voici <b>quelques conseils</b> à suivre :",
  consoTips: [
  ...
  resources3: [
    { link: "/groupe", emoji: "🙅", label: "Vie de groupe", description: "Comment dire non à la pression du groupe ?" },
    { link: "/inte", emoji: "🍾", label: "Pratiques d'intégration", description: "Ce qui est interdit et puni" }
  ],
  ...
  consumptionRefTitle: "Repères de consommation",
    items2: [
  { subtitle: "<b>Limiter la consommation</b> à un maximum de 10 verres par semaine" },
  { subtitle: "<b>Ne pas consommer</b> plus de 2 verres par jour" },
  { subtitle: "<b>Prévoir</b> au moins deux jours sans alcool par semaine" }
],


  consumptionHelpTitle: "Ta consommation ne respecte pas l'un ou plusieurs de ces critères ?",
  consumptionHelpSubtitle: "Fais le point avec des tests de dépistage et informe-toi à ces adresses :",
  resources2: [
    { link: "https://www.alcool-info-service.fr/", imageSrc: "/assets/alcoolinfoservice.jpg", label: "Alcool info service", description: "Un site pour s'informer sur l'alcool et ses conséquences" },
    { link: "https://www.addictaide.fr/", imageSrc: "/assets/addictaide.jpg", label: "Addict'aide", description: "Trouve des outils et des ressources pour ne plus être seul·e face à l'addiction" },
    { link: "https://addictions-france.org/etablissements/", imageSrc: "/assets/cjc.png", label: "Consultations jeunes consommateurs", description: "Trouve une CJC pour t'accompagner près de chez toi" }
  ],
  ...
  helpIntro: "Si tu es témoin d'un comportement dangereux ou irresponsable d'une personne en état d'ivresse, garde <b>un oeil sur elle</b> en veillant à <b>ne pas te mettre en danger</b>.",
  helpPlanTitle: "Plan d'action pour aider une personne ivre et en danger",
  items: [
  ...
  helpTooMuchTitle: "Comment aider quelqu'un qui boit trop (souvent) ?",
  helpTooMuchIntro: "Si tu remarques que quelqu'un s'est mis à boire de manière régulière et/ou excessive, il est important d'agir rapidement. Voici quelques étapes à suivre :",
  items3: [
  ...
  section4Title: "J'organise une soirée",
  organiserText: "Boire un coup entre amis doit rester un <b>moment de convivialité</b> où chacun doit se sentir à l'aise avec sa consommation. Si tu héberges ou planifies une soirée, pense à <b>prévoir des alternatives à l'alcool</b> et à <b>limiter les risques</b> pour tes invité·e·s, notamment en leur rappelant de ne pas boire s'ils doivent conduire ensuite. Pour faire attention à chacun, tu peux trouver des outils pour organiser des <b>soirées plus responsables et sécurisées</b> sur les sites suivants :",
  organiserImage: "/assets/alcool.jpg",
  resources: [
    { link: "https://montetasoiree.com/", imageSrc: "/assets/monte-ta-soiree.png", label: "Monte ta soirée", description: "Un 1er outil pour organiser des soirées plus responsables" },
    { link: "https://pimp-my-party.fr/", imageSrc: "/assets/pimp-my-party.png", label: "Pimp my party", description: "Un 2ème outil pour organiser des soirées en toute sécurité" }
  ],

  sources: "<em><b>Sources :</b> Addict'Aide, Alcool Info Service, Fil Santé Jeunes, Guide 2024 : Les événements festifs et d'intégration étudiants</em>"
};
