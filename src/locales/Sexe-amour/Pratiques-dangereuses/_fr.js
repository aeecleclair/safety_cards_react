const fr = {
  pageTitle: "Infections Sexuellement Transmissibles (IST)",
  navLinks: [
  ...
  quoiTitle: "Qu'est-ce qu'une IST ?",
  quoiIntro: "<b>Une IST (infection sexuellement transmissible)</b> est une infection transmise lors de rapports sexuels, causée par des bactéries, des virus ou des parasites. Souvent silencieuses mais fréquentes, surtout chez les jeunes, elles peuvent entraîner des complications graves si elles ne sont pas dépistées et traitées à temps.",
  carte7Coeur: {
  ...
  detailsTitle: "Qu'est-ce que c'est ?",
  detailsText1: "<b>Une IST (infection sexuellement transmissible)</b> est une infection qui se transmet principalement lors de <b>rapports sexuels</b> (vaginaux, anaux ou oraux). Elles peuvent être causées par des <b>bactéries, des virus ou des parasites.</b>",
  detailsText2: "Les IST sont très fréquentes, en particulier chez les jeunes et les personnes ayant des partenaires multiples. Beaucoup d'IST sont <b>asymptomatiques</b> (silencieuses) mais peuvent entraîner des complications graves si elles ne sont pas traitées.",
  chiffres: [
  ...
  commonIstTitle: "Les types d'IST les plus courantes sont :",
  istList: ["Chlamydia", "Gonorrhée (gonocoque)", "Syphilis", "VIH", "Herpès (HSV)", "HPV (papillomavirus)", "Hépatite B"],
  illustrationSource: "Source de l'illustration : depistage.be.",
  vihSidaNote: "Le VIH (virus de l'immunodéficience humaine) est une <b>infection sexuellement transmissible</b>, mais il ne provoque pas toujours le SIDA. Le <b>VIH</b> est le virus, tandis que le <b>SIDA</b> (syndrome d'immunodéficience acquise) correspond au stade avancé de l'infection, lorsque le système immunitaire est affaibli et que des maladies opportunistes apparaissent. Grâce aux traitements actuels, une personne vivant avec le VIH peut rester en bonne santé, ne pas transmettre le virus et ne jamais développer le SIDA.",
  transmissionTitle: "Comment ça se transmet ?",
  transmissionIntro: "Les IST se transmettent <b>principalement par contact direct avec les muqueuses ou les liquides corporels</b> (sang, sperme, sécrétions vaginales) lors de <b>rapports sexuels non protégés</b>. Certaines IST peuvent aussi se transmettre par d'autres voies :",
  transmissionList: [
  ...
  oralSexRisk: "Oui, <b>les IST peuvent se transmettre par le sexe oral</b> (cunnilingus, fellation, anulingus). Le risque est généralement plus faible que pour les rapports vaginaux ou anaux, mais il n'est pas nul.",
  symptomesTitle: "Quels sont les symptômes ?",
  symptomesIntro: "Beaucoup d'IST peuvent être <b>asymptomatiques</b> (silencieuses). Quand il y a des signes, il peut s'agir de :",
  symptomesList: [
  ...
  asymptomaticNote: "<b>Même sans symptômes, une IST peut se transmettre</b> et provoquer des complications si elle n'est pas traitée : infertilité, douleurs chroniques, complications pendant la grossesse, risques accrus d'acquisition du VIH, etc.",
  consultNote: "D'autres maladies peuvent provoquer ce type de symptômes, comme par exemple les mycoses vaginales ou les infections urinaires. Pour ces raisons, il est important de consulter un professionnel de santé en cas de doute, ou d'<b>effectuer un dépistage</b>.",
  resourcesIntro: [
    { link: "https://www.questionsexualite.fr/s-informer-sur-les-infections-et-les-maladies/qu-est-ce-qu-une-infection-sexuellement-transmissible/qu-est-ce-qu-une-ist?at_medium=sl&at_campaign=2024-04-01-Changer-SEA-SPF-Question+Sexualit%C3%A9_ISTMST_Textuelle-604989&at_format=R-Visibilite-dCPC-GA-GrandPublic-Generique-RSA&gclsrc=aw.ds&gad_source=1&gad_campaignid=21177196714&gbraid=0AAAAAD8OEM2z-ZH9CJepMuWU1gvu4taJx&gclid=Cj0KCQjwgKjHBhChARIsAPJR3xfqC9RjKddnwf3ciSv1lZQnPbTX5_cjcfNZXJUNwr5ggmPmNV0A_ZwaAgAhEALw_wcB", imageSrc: "/assets/question_sexualite.png", label: "Question Sexualité", description: "Informations claires et accessibles sur les IST" },
    { link: "https://www.sante.fr/comment-reconnaitre-une-ist", imageSrc: "/assets/sante_fr.png", label: "Sante.fr", description: "Fiches pratiques : comment reconnaître une IST ?" }
  ],
  protectionTitle: "Comment s'en protéger ?",
  protectionIntro: "<b>La prévention combinée</b> est la plus efficace : préservatif, vaccination quand elle est disponible, dépistage régulier et réduction des facteurs de risque.",
  protectionList: [
  ...
  oralProtection: "Utiliser la bonne protection lors de rapports oraux permet aussi de réduire le risque de transmission d'une IST. Utiliser un <b>préservatif masculin</b> en cas de fellation et une <b>digue dentaire</b> (carré de latex) ou un préservatif coupé pour un cunilingus/anulingus.",
  resourcesOral: [{ link: "https://www.sante.fr/fellation-cunnilingus-anulingus-peut-attraper-des-ist-par-la-bouche", imageSrc: "/assets/sante_fr.png", label: "Sante.fr", description: "Informations et conseils pour se protéger lors de rapports oraux" }],
  condomLimit: "Le préservatif n'offre pas une protection totale contre les IST qui se transmettent par contact cutané (ex. herpès, syphilis), mais il réduit significativement le risque.",
  womenSexNote: "Pour les rapports entre femmes, l'utilisation de barrières comme les digues dentaires, les préservatifs internes ou les gants en latex peut également réduire le risque de transmission selon les pratiques.",
  resourcesWomen: [{ link: "https://cemagcare.com/les-ist-et-les-rapports-sexuels-entre-femmes-fsf/", imageSrc: "/assets/cemag.jpg", label: "Cemag Care", description: "Pour en savoir plus sur la protection des IST dans les rapports entre femmes (personnes menstruées)" }],
  vaccinationTitle: "La vaccination",
  vaccinationIntro: "Des <b>vaccins efficaces</b> existent pour prévenir certaines IST :",
  vaccinationList: [
  ...
  noVaccineNote: "Il n'existe pas de vaccin contre le VIH, la chlamydia, la gonorrhée ou la syphilis, mais la recherche est en cours.",
  prepTitle: "La PrEP pour le VIH",
  prepText: "La <b>PrEP (prophylaxie pré-exposition)</b> est un traitement préventif qui réduit fortement le risque d'infection par le VIH chez les personnes à risque élevé. Il s'agit de prendre un médicament antirétroviral avant et après une exposition potentielle au virus (par exemple, lors de rapports sexuels non protégés avec un partenaire séropositif).",
  resourcesPrep: [{ link: "https://www.sida-info-service.org/dossier-la-prep/#:~:text=La%20PrEP%2C%20(Prophylaxie%20Pr%C3%A9%2D,%C3%AAtre%20contamin%C3%A9%20par%20le%20VIH.", imageSrc: "/assets/sida.jpg", label: "PrEP Info", description: "Si tu as des rapports sexuels avec des partenaires porteurs du VIH" }],
  prejugesTitle: "Préjugés sur les IST",
  prejugesIntro: "Les IST sont souvent entourées de <b>préjugés et de stigmatisation</b>, ce qui peut empêcher les personnes concernées de se faire dépister ou traiter. Il est important de rappeler que :",
  prejugesList: [
  ...
  pagesDiscri: [
    { link: "/discri", emoji: "🟰", label: "Discriminations", description: "S'informer sur les discriminations liées à la sexualité"},
    { link: "/sex_orient", emoji: "🏳️‍🌈", label: "Orientation sexuelle", description: "Plus d'informations sur l'orientation sexuelle" }
  ],
  depistageTitle: "Se faire dépister",
  depistageIntro: "Il est recommandé de se faire <b>dépister régulièrement</b>, notamment après un rapport non protégé, avant d’arrêter le préservatif avec un nouveau partenaire ou en cas de doute. Le dépistage est <b>simple, gratuit et confidentiel</b> dans les CeGIDD ou via le dispositif « Mon Test IST », qui permet aux 18-25 ans de faire un test sans ordonnance, en laboratoire ou chez soi.",
  whenTitle: "Quand se faire dépister ?",
  whenIntro: "Il est recommandé de se faire dépister :",
  whenList: [
  ...
  howText: "Le dépistage peut se faire par <b>prise de sang, test urinaire ou prélèvement local</b> (urètre, col, gorge, rectum) selon l'IST recherchée. Le dépistage peut se faire <b>gratuitement et de manière anonyme dans les CeGIDD</b> (Centres gratuits d'information, de dépistage et de diagnostic), les centres de santé sexuelle, ou chez un professionnel de santé (médecin, gynécologue, infirmier·e). Certains tests rapides sont aussi disponibles en pharmacie ou en ligne.",
  contactCegidd: {
  ...
  monTestIstText: "Depuis 2024, le <b>dispositif « Mon Test IST »</b> permet de se présenter directement en laboratoire pour un <b>bilan IST sans ordonnance et gratuit pour les 18-25 ans</b>. Il est même possible de <b>commander un kit de dépistage par auto-prélèvement</b> pour les infections à Chlamydia et à gonocoque.",
  resourcesDepistage: [
    { link: "https://www.ameli.fr/assure/sante/themes/mst-ist/depistage", imageSrc: "/assets/ameli.png", label: "Ameli", description: "Informations officielles sur le dépistage des IST" },
    { link: "https://mon-test-ist.ameli.fr/", imageSrc: "/assets/mon_test_ist.jpg", label: "Mon Test IST", description: "Dépistage en labo ou chez soi sans ordonnance" }
  ],
  ...
  traitementsDetailsText: "Le traitement des IST dépend de l'agent infectieux en cause. Les IST bactériennes (ex. chlamydia, gonorrhée, syphilis) sont en général <b>soignées par des antibiotiques</b>. Les IST virales (ex. herpès, VIH) se <b>contrôlent</b> par des antiviraux — pour le VIH, un traitement antirétroviral permet d'atteindre une charge virale indétectable et d'empêcher la transmission.",
  resourcesTreatments: [{link: "https://www.ameli.fr/assure/sante/themes/mst-ist/traitement", imageSrc: "/assets/ameli.png", label: "Ameli", description: "Informations officielles sur le traitement des différentes IST" }],
  treatmentCompliance: "Il est crucial de <b>suivre le traitement prescrit jusqu'au bout</b>, même si les symptômes disparaissent rapidement. Ne pas interrompre le traitement peut entraîner une résistance aux médicaments et des complications.",
  treatmentPrecaution: "Pendant le traitement, il est recommandé d'<b>éviter les rapports sexuels</b> ou d'<b>utiliser systématiquement un préservatif</b> pour prévenir la transmission aux partenaires. Informer ses partenaires récents permet également de limiter la propagation des IST.",
  treatmentFollowup: "Après le traitement, un <b>contrôle de dépistage</b> peut être nécessaire pour s'assurer de la guérison, surtout pour certaines IST comme la syphilis ou le VIH.",
  contactSidaInfo: {
  ...
  pepTitle: "La PEP après une exposition au VIH",
  pepText: "La <b>PEP (prophylaxie post-exposition)</b> ou TPE (traitement post-exposition) est un traitement d'urgence qui peut prévenir l'infection par le VIH après une exposition récente (moins de 48-72 heures). Elle consiste en une prise quotidienne d'antirétroviraux pendant 28 jours et doit être commencée le plus rapidement possible après l'exposition.",
  resourcesPep: [{ link: "https://www.sida-info-service.org/risque-moins-de-48-heures/", imageSrc: "/assets/sida.jpg", label: "PEP Info", description: "Si tu as été exposé·e au VIH il y a moins de 48h" }],
  pratiquesTitle: "Pratiques à risques",
  pratiquesIntro: "Les pratiques sexuelles à risque sont celles qui favorisent la transmission des IST. <b>L'alcool et les drogues peuvent altérer le jugement</b>, augmenter les comportements à risque et <b>annuler la validité du consentement</b>, ce qui peut avoir des <b>conséquences pénales graves.</b>",
  pratiquesListIntro: "Les pratiques sexuelles à risques sont celles qui <b>augmentent le risque de transmission des IST</b>. Cela inclut :",
  pratiquesList: [
  ...
  substancesTitle: "Relations sexuelles sous l'emprise de substances",
  ...
  sourcesList: "Santé Publique France, Sante.fr, Ameli (Mon Test IST), OMS, Sida Info Service"
};
