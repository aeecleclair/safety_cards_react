// fr.js — Textes en français pour la page Anxiété
...
const fr = {
  ...
  definitionTitle: "Comprendre l'anxiété et les troubles anxieux",
  definitionText1: "L'<b>anxiété</b> est liée à des peurs ressenties dans l'environnement. Elle peut se manifester par de l'inquiétude, une attention extrême portée au regard des autres, à des intéractions sociales ou à des erreurs. Elle peut aussi s'accompagner d'une activation corporelle (cœur qui bat plus vite, tension musculaire, etc.), mais chacun est susceptible de réagir de manière différente.",
  definitionText2: "Les <b>troubles anxieux</b> correspondent à une inquiétude plus importante et plus persistante, qui altère le fonctionnement quotidien (activités, travail, relations sociales, etc.). Les troubles anxieux sont les troubles de santé mentale les plus courants dans le monde.",
  definitionText3: "On distingue l'anxiété de l'<b>angoisse</b> : l'anxiété est diffuse et anticipatoire, souvent liée à la peur qu'un problème survienne, tandis que l'angoisse correspond à une crise aiguë, brutale, avec des symptômes physiques intenses comme une sensation d'étouffer, des palpitations ou l'impression de perdre le contrôle.",
  ...
  typesTroublesTitle: "Les différents types de troubles anxieux",
  typesTroublesIntro: "Il existe de nombreux troubles anxieux. Ils sont ici rangés par fréquence décroissante.",
  typesTroublesList: [
  ...
  troublesComplement: "Dans les faits, il est fréquent de cumuler plusieurs troubles anxieux. Si le degré d'anxiété devient trop élevé, cela peut mener à une dépression, et encourager la personne à consommer davantage d'alcool ou de drogues, ce qui a pour effet d'accroitre les troubles anxieux.",

  ressourcesTroubles: [
    { link: "/depression", label: "Dépression", description: "Comprendre et agir", emoji: "🥺" },
    { link: "/alcool", label: "Consommation d'alcool", description: "Consommation d'alcool et addictions éventuelles", emoji: "🍺" },
    { link: "/stup", label: "Consommation de stupéfiants", description: "Effets, risques et ressources", emoji: "🎆" }
  ],
  ...
  autresRessourcesIntro: "Si tu as besoin d'autres ressources d'aide, de parler ou d'être écouté·e, tu peux aussi t'orienter vers les services suivants :",
  ...
  accompagnantTitle: "J'accompagne ou je suis témoin",
  itemsAererTitle: "Plan d'action pour les Premiers Secours en Santé Mentale (Plan AÉRER)",
  itemsAererSubtitle: "Comment aider un personne victime de troubles anxieux ?",
  itemsAerer: [
    {
  ...
  accompagnantMiseAvant1: "Pour se rétablir des troubles anxieux, il faut faire face aux situations sources d'anxiété, et non les éviter.",
  accompagnantMiseAvant2: "Ne minimise pas les peurs de la personne, avec des phrases comme « Ce n'est pas grave » ou « Il n'y a pas de quoi avoir peur ». Ne lui dis pas de « s'endurcir » ou de « relativiser ».",

  ressourcesAerer: [
    { link: "/suicide", label: "La victime a des idées suicidaires", description: "Comment réagir et l'aider ?", emoji: "🗣️" },
    { link: "/automutilation", label: "La victime s'automutile", description: "Comment réagir et l'aider ?", emoji: "🦓" }
  ],

  assisterPaniqueTitle: "Assister en cas d'attaque de panique",
  assisterPaniqueList: [
