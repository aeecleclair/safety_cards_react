const fr = {
  pageTitle: "Endométriose & Douleurs menstruelles",
  ...
  /* -------------------- DOULEURS -------------------- */
  sectionDouleursTitle: "Les douleurs menstruelles",

  douleursIntro:
    "Les douleurs menstruelles sont fréquentes et peuvent parfois être très intenses. <b>Si elles deviennent invalidantes, elles peuvent révéler un problème comme l'endométriose.</b> Il ne faut pas les minimiser et consulter un·e professionnel·le de santé.",
  ...
  /* -------------------- DÉFINITION -------------------- */
  sectionDefinitionTitle: "Comprendre l'endométriose",

  definitionIntro:
    "L'endométriose est une <b>maladie chronique</b> qui touche environ 1 femme sur 10 et provoque des douleurs souvent intenses et invalidantes. Les signes à surveiller : <b>règles très douloureuses</b>, <b>douleurs pendant les rapports</b>, <b>fatigue chronique</b>, <b>troubles digestifs ou urinaires</b>, etc.",
  ...
  signesTitle: "Les signes à surveiller",
  signesList: [
  ...
  /* -------------------- TÉMOIN -------------------- */
  sectionTemoinTitle: "Je suis concerné·e",
  ...
  precariteText:
    "Si tu manques de moyens pour te fournir des protections menstruelles, n'hésite pas à te rendre sur la page dédiée de ce site web, qui <b>répertorie</b> des associations ou des structures qui peuvent t'aider.",
  ...
  resourcesSubtitle: "Pour mieux comprendre la maladie, ses impacts et les accompagnements possibles",
  ...
  /* -------------------- AIDANT -------------------- */
  sectionAidantTitle: "Je veux aider",

  aidantIntro:
    "Tu connais une personne qui souffre de douleurs menstruelles intenses ou d'endométriose ? Ton soutien peut faire une vraie différence.",

  aidantPlanTitle:
    "Plan d'action pour aider une personne qui souffre de douleurs menstruelles",
  ...
  sources:
    "<em><b>Sources :</b> EndoFrance, INSERM, Ministère de la Santé, HAS</em>",
};
