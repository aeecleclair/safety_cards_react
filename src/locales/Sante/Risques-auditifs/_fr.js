const fr = {
  pageTitle: "Risques auditifs",

  navLinks: [
    { label: "Comprendre les risques auditifs", target: "definition" },
    { label: "J'ai des troubles auditifs", target: "troubles" },
    { label: "Les mauvais réflexes", target: "mauvais-reflexes" },
    { label: "Comment mieux protéger mon ouïe ?", target: "solutions" },
  ],

  /* ===================== COMPRENDRE LES RISQUES AUDITIFS ===================== */

  sectionDefinitionTitle: "Comprendre les risques auditifs",
