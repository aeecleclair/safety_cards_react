// fr.js — Textes en français pour la page Situation de Handicap

const fr = {
  pageTitle: "Situation de Handicap",
  ...
  chiffresData: [
    {
      number: "8,9%",
      title: "des personnes",
      description: "ont au moins un handicap parmi les catégories suivantes : troubles moteurs, sensoriels, du langage, psychiques, viscéraux, cognitifs et autistiques"
    },
    {
      number: "12%",
      title: "des étudiants",
      description: "déclarent avoir un trouble de santé durable ayant un impact sur leurs études (source : OVE, 2020)"
    }
  ],
  ...
  jeunesAidants: [
    {
      title: "Brind'Écoute",
      subtitle: "Service d'écoute (chat/sms/téléphone) pour jeunes aidants"
    },
    {
      title: "Brind'Partage",
  ...
  constatIntro: "Le handicap recouvre une grande diversité de réalités, qu'il soit visible ou invisible. Il peut être temporaire ou permanent, et concerner des fonctions physiques, mentales, cognitives ou sensorielles. Dans le contexte universitaire, cela peut impacter la mobilité, la communication, la concentration ou encore l'accès à l'information.",
  ...
  internesTitle: "Les aides à Centrale",
  internesIntro: "L'école met en œuvre des mesures concrètes pour garantir l'égalité des chances. Des actions de sensibilisation sont régulièrement proposées à l'ensemble de la communauté étudiante et enseignante pour favoriser l'inclusion. Un accompagnement individualisé peut être mis en place en fonction des besoins exprimés.",
  internesBulletList: [
  ...
  externesTitle: "Ressources externes",
  externesIntro: "De nombreuses structures extérieures proposent un accompagnement complémentaire, que ce soit sur le plan médical, social ou éducatif. Ces ressources sont utiles à la fois pour les démarches administratives et pour le soutien psychologique.",
  ...
  droitsTitle: "Droits des personnes en situation de handicap",
  droitsIntro: "Il existe en France de nombreux dispositifs pour compenser les conséquences du handicap et soutenir les parcours de formation. Ces droits peuvent concerner la scolarité, le financement, l'accessibilité ou encore l'accès à l'emploi. Leur mise en œuvre dépend souvent d'une reconnaissance administrative.",
  listeTitre: "Principaux dispositifs",
  listeText: "Aides et allocations",

  aidantsTitle: "Soutien aux jeunes aidants",
  aidantsIntro: "Les jeunes aidants sont souvent invisibles. Ce sont des personnes entre 7 et 25 ans qui accompagnent au quotidien un proche en situation de handicap, de maladie, de dépendance ou d'addiction, tout en poursuivant leurs études. Ils sont plus d'un million en France. Ces situations peuvent générer de la fatigue, de l'isolement ou des difficultés scolaires. Des structures comme La pause Brindille visent à leur offrir un espace d'écoute, de partage et de répit.",

  associationTitle: "S'adapter en tant qu'association",
  associationIntro: "Des ressources existent pour accompagner les associations dans la prise en compte du handicap dans l'organisation d'événements ou d'activités.",
