// fr.js — Textes en français pour la page Orientation sexuelle
...
const fr = {
  ...
  definitionsTitle: "Qu'est-ce que l'orientation sexuelle ?",
  ...
  reperesTitle: "Quelques repères",
  reperesIntro:
    "Il peut y avoir autant d'orientations sexuelles que de personnes. On dénombre toutefois le plus souvent les 6 suivantes :",
  ...
  connaitreOriTitle: "Comment connaitre mon orientation sexuelle ?",
  connaitreOriText1: "Il est normal de se poser des questions sur son orientation sexuelle, au gré de sa vie et de ses expériences. Il est donc tout à fait normal que tu aies des doutes ou des questionnements.",
  connaitreOriText2: "Mettre des mots sur ce que l'on ressent peut prendre du temps, et on ne se retrouve pas forcément dans une orientation précise. Tu as le droit ne pas savoir. Ce n'est pas parce qu'un garçon est attiré par un garçon qu'il est gay ou bisexuel. Tu as le droit d'expérimenter, cela t'aidera à te découvrir, et te permettra peut-être de découvrir de nouveaux plaisirs ! ",
  connaitreOriText3: "Si tu en ressens le besoin, tu peux en parler à des personnes de confiance, ou à des professionnel·le·s, par exemple via le tchat de Comment on s'aime ?.",
  ...
  orientationCommentTitle: "Comment connaitre mon orientation sexuelle ?",
  orientationCommentText1:
    "Il est normal de se poser des questions sur son orientation sexuelle, au gré de sa vie et de ses expériences. Il est donc tout à fait normal que tu aies des doutes ou des questionnements.",
  orientationCommentText2:
    "Mettre des mots sur ce que l'on ressent peut prendre du temps, et on ne se retrouve pas forcément dans une orientation précise. Tu as le droit ne pas savoir. Ce n'est pas parce qu'un garçon est attiré par un garçon qu'il est gay ou bisexuel. Tu as le droit d'expérimenter, cela t'aidera à te découvrir, et te permettra peut-être de découvrir de nouveaux plaisirs !",
  orientationCommentText3:
    "Si tu en ressens le besoin, tu peux en parler à des personnes de confiance, ou à des professionnel·le·s, par exemple via le tchat de Comment on s'aime ?.",
  ...
  heteronormTitle: "Qu'est ce que l'hétéronormativité ?",
  heteronormText1:
    "C'est le fait de considérer que tout le monde est hétérosexuel par défaut, sauf mention contraire. Ainsi, il est supposé qu'une femme sera attirée par les hommes et un homme par les femmes.",
  heteronormText2:
    "Cela pose problème pour les personnes ne se définissant pas comme hétérosexuelles, car leurs expériences et identités peuvent être invalidées ou ignorées. Il est ainsi plus difficile pour elles de s'accepter et de se faire accepter par leur entourage, ce qui peut les décourager de faire leur coming out ou de parler de leurs sentiments.",

  outingTitle: "Qu'est ce que l'« outing » ?",
  outingText1:
  ...
  outingText2:
    "L'outing peut avoir des conséquences graves sur la vie de la personne concernée, notamment en termes de sécurité, de santé mentale et de relations sociales.",
  ...
  ressourcesSexTitle: "Pour en apprendre davantage sur la sexualité et l'orientation sexuelle",
  ressourcesSex: [
    {
  ...
  discriText:
    "Si tu es victime de discriminations en raison de ton orientation sexuelle, sache qu'il existe des ressources et des personnes prêtes à t'aider.",
  ...
  comingOutTitle: "Parler de son orientation",
  comingOutIntro:
  ...
  comingOutConseilsTitle: "Conseils pour t'aider",
  ...
  ressourcesGeneralesTitle: "Ressources pour aller plus loin",
  ressourcesGeneralesSubtitle:
    "Il y a également des numéros de téléphone ou des endroits dans Lyon pour discuter de ta sexualité si tu en ressens le besoin :",
  ...
  soutienTitle: "Accompagner & soutenir",
  soutienIntro:
