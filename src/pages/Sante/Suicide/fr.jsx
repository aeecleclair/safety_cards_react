export default {
  titlePage: "Tentative et comportement suicidaires",
  navLinks: [
  ...
  reasonsTitle: "Les raisons invoquées par les personnes ayant tenté de se suicider",
  reasonsIntro:
  ...
  sufferingTitle: "Je suis en souffrance",
  feelBadTitle: "Je me sens mal ou dépassé·e",
  feelBadIntro:
  ...
  psyResources: [
    {
      ...
      description:
        "12 séances gratuites avec un·e psychologue",
    },
  ],
  infirmaryCard: {
  ...
  suicidalIdeasTitle: "J'ai des idées suicidaires",
  suicidalIdeasIntro:
  ...
  anchorPlanButtonLabel:
    "Etablir mon plan de sécurité avec un secouriste ↓",
  resource3114: {
    link: "https://3114.fr/je-suis-en-souffrance/",
    title: "3114",
    description:
      "Je suis en souffrance : les questions que tu peux te poser, les témoignages et conseils.",
    imageSrc: "/assets/3114.jpg",
  },

  whoToTalkTitle: "A qui en parler ?",
  whoToTalkListHtml: [
  ...
  worriedTitle: "Je m'inquiète pour quelqu'un",
  card4_diamond: {
    ...
    longText:
      "Il ne faut pas hésiter à parler de tes inquiétudes avec la personne concernée. Parfois, le simple fait de poser la question du suicide ou de montrer son inquiétude à l'autre peut aider. Si tu sens que la situation est urgente, n'hésite pas à contacter un professionnel ou les urgences.",
    buttonText: "⤢ Agrandir la carte",
    suit: "carreau",
  },
  signsTitle: "Les signes d'alerte et les facteurs de risques",
  signsIntro:
  ...
  cautionHtml:
    "<b>Attention :</b> certaines personnes plus fragiles peuvent agir de manière compulsive, sans que leur mal être soit visible.",
  alcoholDrugsHtml:
    "La consommation d'<b>alcool</b> ou de <b>substances</b> peut aussi aggraver les comportements suicidaires.",
  risksLinks: [
    { link: "/alcool", label: "Alcool", description: "Comment aborder la consommation d'alcool ?", emoji: "🍺" },
    { link: "/stup", label: "Stupéfiants", description: "Comment aborder la consommation de stupéfiants ?", emoji: "🎆" },
  ],
  ...
  startConversationTitle: "Entame la conversation",
  startConversationCheckHtml:
    "<b>Interroge-toi :</b> es-tu capable de mener cette conversation, et es-tu disponible et à l'écoute ?",
  startConversationPlaceHtml:
    "<b>Choisissez un cadre agréable qui vous convienne à tou·te·s les deux :</b> dans un endroit calme et isolé, au parc ou autour d'un café, au téléphone...",
  startConversationMentionHtml: "<b>Mentionnez ce que vous avez remarqué sans juger ni culpabiliser :</b>",
  ...
  askSuicideHtml:
    "<b>Aborder la question du suicide :</b><br/>- Il faut être direct pour lui donner la possibilité de parler de ses souffrances (cela montre que tu t'inquiètes pour lui ou elle) : « As-tu des idées suicidaires ? », « Envisages-tu de te donner la mort ? »<br/>- Pas de jugement de valeur (ex. « quelque chose de stupide »), pas de sous-entendu<br/>- Reste calme et empathique",
  cannotLeadText:
  ...
  urgencyTitle: "Détermine l'urgence de la situation",
  urgencyIntro:
  ...
  securityPlanSectionTitle:"Construire un plan de sécurité",
  securityPlanTitle: "Construire un plan de sécurité",
  ...
  emergencyContactsTitle: "Les contacts d'urgence",
  contact3114: { image: "/assets/3114.jpg", title: "3114", subtitle: "Numéro national de prévention du suicide", phone: "3114", email: "", hours: "24h/24 et 7j/7", textButton: "Voir le site web", link: "https://3114.fr/" },
  contactSAMU: { image: "/assets/15.png", title: "SAMU", subtitle: "Urgence médicale", phone: "15", textButton: "Appeler", link: "tel:15", bgColor: "#ffffff", textColor: "#ee3624" },
  contactInfirmary: {
    image: "/assets/2024_LOGO-CENTRALE-H_ROUGE_CMJN_carre.png",
    title: "Infirmerie",
    subtitle: "Infirmerie de Centrale Lyon",
  ...
  selfHarmLink: {
    ...
    description:
      "Savoir comment réagir en cas d'automutilation non suicidaire.",
    emoji: "🦓",
  },

  selfCareTitle: "Respecte tes propres limites et prends soin de toi",
  selfCareIntro: "Tu es un·e ami·e, pas un·e thérapeute.",
  selfCareListHtml: [
  ...
  selfCareImportantHtml: "<b>Il est donc important que tu :</b>",
  ...
  impactTitle: "Je suis impacté·e par un suicide",
  cardD_pique: {
    ...
    longText:
      "Lorsqu'on est confronté à un suicide, il est normal de ressentir une multitude d'émotions : tristesse, colère, culpabilité. Le processus de deuil peut être long et difficile, mais il est essentiel de prendre le temps de vivre ces émotions. Tu peux te faire aider par des pairs ou des professionnel·le·s.",
    buttonText: "⤢ Agrandir la carte",
    suit: "pique",
  },
  ...
  impactResources: [
    {
      ...
      description:
        "Comment comprendre et accepter ? Est-ce normal de se sentir coupable ? etc.",
      imageSrc: "/assets/3114.png",
    },
  ],
  nightlineCard: {
  ...
  witnessTitle: "J'ai été témoin d'un suicide",
  witnessIntro:
  ...
  griefTitle: "Comment traverser le deuil ?",
  griefTextHtml:
    "<b>Les premiers jours qui suivent un suicide engendrent quelque fois une perception déformée de la réalité, une sidération.</b> Cette période est généralement suivie d'un chaos dans les pensées et les sentiments, engendrant par là des questions comme « Pourquoi ? », « Aurais-je pu remarquer quelque chose ? », « Qu'aurais-je pu faire ? », « Pourquoi ne m'a-t-elle/il pas parlé de sa souffrance ? ». La douleur de la perte peut s'accompagner de réflexions relatives à l'abandon, l'impuissance, le désespoir, la culpabilité, la colère… <b>Les personnes endeuillées par suicide rapportent qu'à un moment, contre toute attente, elles découvrent qu'il y a de la place pour autre chose : un projet, un espoir.</b> Ce n'est pas tant que ton chagrin diminue ; c'est que tu grandis avec ton chagrin.",
  witnessResources: [
    {
  ...
  pssmTitle: "Pour aller + loin : la formation PSSM",
  pssmText:
  ...
  sourcesHtml:
    "<em><b>Sources :</b> Etat de l'Enseignement supérieur, de la Recherche et de l'Innovation en France n°13, 3114, PSSM France</em>",
};
