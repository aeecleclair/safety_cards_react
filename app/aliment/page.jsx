...
import Quote from "@/app/components/Citation";
import ImageTextPopup from "@/app/components/Cartes";
import ListeNumerotee from "@/app/components/Listes";
import ExternalLinkBlock from "@/app/components/Liens-ext";
import { BulletList, TextImageRight, ImageCenter } from "@/app/components/Common";
import Sommaire from "@/app/components/Sommaire";
import ContactCard from "@/app/components/Contact";
import { Chiffre, ChiffresGroup } from "@/app/components/Chiffres";
import Separateur from "@/app/components/Separateur";
...
export default function Alimentation() {
  return (
    <div className="page">
      ...
      <ExternalLinkBlock resources={resources2bis} />
